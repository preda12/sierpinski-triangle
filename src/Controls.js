...
export const Controls = (props) => {
  ...
  return (
    <div>
      ...
      <div>
        <input type="checkbox" id="show_starting_point" name="show_starting_point" value="true" onChange={(event) => showStartingPoint(event.target.checked)} checked={isStartingPointShown}/>
